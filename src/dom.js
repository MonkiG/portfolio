...
const projectsSectionLis = $$('#projects li')
...
export function addReposToProjectsSection () {
  ...
  //   }
  console.log(projectsSectionLis[projectsSectionLis.length - 1])
  if (projectsSectionLis.length % 2 !== 0) {
    projectsSectionLis[projectsSectionLis.length - 1].className = 'col-span-2 text-center m-auto transition-all duration-500 hover:scale-110'
  }
